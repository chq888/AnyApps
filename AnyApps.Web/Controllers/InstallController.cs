...
namespace AnyApps.Web.Controllers
{
    ...
    public class InstallController : Controller
    {
        ...
        public InstallController(IUnitOfWorkAsync unitOfWorkAsync, IProductService customerService, IPluginFinder pluginFinder)
        {
        ...
        public ActionResult CheckAndInstall(InstallModel model)
        {
            ...
            {
                Database = AnyConstants.DATABASE_NAME,
                DatabaseLogin = "",
                DatabasePassword = "",
                DatabaseType = (int)DatabaseType.MsSqlServer,
                Email = "",
            ...
            switch ((DatabaseType)model.DatabaseType)
            {
                ...
                default:
                    ...
                    connectionStringSettings = new ConnectionStringSettings(AnyConstants.CONNECTION_STRING, connectionString, "System.Data.SqlServerCe.4.0");
                    break;
                case DatabaseType.MsSqlServer:
                    ...
                    connectionStringSettings = new ConnectionStringSettings(AnyConstants.CONNECTION_STRING, connectionString, "System.Data.SqlClient");
        ...
        public async Task<ActionResult> Install(InstallModel model)
        {
            ...
            System.Data.Entity.Database.SetInitializer(new AnyDbInitializer(model));

            // initialize and create database
            using (var context = new AnyDbContext())
            {
